...
<script>
export default {
  name: "HomeCommentsMaker",
};
</script>

<style scoped>
#commentsMaker {
  background-image: url("../../../../assets/Common/school.jpg");
...
input:-webkit-autofill {
  ...
  box-shadow: 0 0 0 1000px #1eaaf1 inset;
  -webkit-box-shadow: 0 0 0 1000px #1eaaf1 inset;
